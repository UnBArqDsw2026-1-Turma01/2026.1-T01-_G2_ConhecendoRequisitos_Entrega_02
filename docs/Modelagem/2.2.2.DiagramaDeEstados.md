...
| ------ | ----- | ------------------------------------------ | ------------------------------------------------- | -------------------------------------------------- | ------------------- |
| 1.0    | 23/04 | Criação do arquivo, introdução e objetivo. | [Eduarda Rodrigues](https://github.com/eduardar0) | [Letícia Lopes](https://github.com/leticialopes20) | Documento criado    |
