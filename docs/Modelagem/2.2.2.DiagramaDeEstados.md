...
Na construção do diagrama, o principal exercício de senso crítico foi garantir que os elementos representados realmente refletissem o funcionamento do sistema, sem adicionar complexidade desnecessária. A equipe teve cuidado em definir corretamente as relações e responsabilidades, evitando redundâncias e mantendo o modelo claro e organizado. Também foram discutidas algumas decisões de estrutura para garantir que o diagrama fosse fácil de entender e útil para as próximas etapas do projeto.

O trabalho em equipe ocorreu de forma colaborativa, com os membros contribuindo na definição dos elementos, validação das relações e revisão geral do diagrama. As discussões ajudaram a identificar ajustes importantes e alinhar o entendimento do grupo sobre o sistema. Com isso, o resultado final ficou mais consistente, bem estruturado e adequado tanto para desenvolvimento quanto para documentação.
...
| ------ | ------ | ----------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------ | -------------------------- |
| 1.0    | 23/04  | Criação do arquivo e introdução     | [Eduarda Rodrigues](https://github.com/eduardar0)                         | [Leticia Maria](https://github.com/leticialopes20) | Documento criado           |
| 1.1    | 23/04  | Criação do diagrama e documento     | [Eduarda Rodrigues](https://github.com/eduardar0), [Yasmim Moreira](https://github.com/Yasm1nNasc1mento) | [Leticia Maria](https://github.com/leticialopes20) | Diagrama adicionado        |
| 1.2    | 23/04  | Adição do senso crítico             | [Yasmim Nascimento](https://github.com/Yasm1nNasc1mento)                     | [Eduarda Rodrigues](https://github.com/eduardar0) | Conteúdo complementado     |