...
| ------ | ----- | -------------------- | ------------------------------------------------ | ---------------------------------------------------------- |
| 1.0    | 18/04 | Criação do documento | [Yan Matheus](https://github.com/Yanmatheus0812) | [Isabella Choukaira](https://github.com/isabellachoukaira) |
| 1.1    | 18/04 | Correção no Diagrama que estava em uma versão anterior | [Arthur Evangelista](https://github.com/arthurevg) | [Isabella Choukaira](https://github.com/isabellachoukaira) |
