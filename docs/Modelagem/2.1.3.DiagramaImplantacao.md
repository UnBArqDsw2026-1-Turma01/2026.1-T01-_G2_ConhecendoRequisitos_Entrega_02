...
|--------|------------|----------------------------------------|---------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------|
| 1.0    | 19/04/2026 | Criação do documento                   | [Yasmin Nascimento](https://github.com/Yasm1nNasc1mento) | [Isabella Choukaira](https://github.com/isabellachoukaira)  |  Documento criado | 
| 1.1    | 22/04/2026 | Revisão textual e ajustes estruturais | [Eduarda Rodrigues](https://github.com/eduardar0) | — | Correção gramatical, padronização e melhoria de clareza |
