...
> YOUTUBE. **Como Fazer Diagrama de implantação da UML**. Disponível em: [https://www.youtube.com](https://www.youtube.com/watch?v=eFFq3SLMQJ4&list=PLx6gdu4s3nkf34QO3SKMmhN5f6naRucu8&index=11). Acesso em: 19 abr. 2026.

> SERRANO, Milene. Arquitetura e Desenho de Software. Material Complementar do Módulo: Modelagem UML Estática. Disponível em: https://aprender3.unb.br/pluginfile.php/3178534/mod_page/content/1/Arquitetura%20e%20Desenho%20de%20Software%20-%20Aula%20Modelagem%20UML%20Din%C3%A2mica%20-%20Profa.%20Milene.pdf. Universidade de Brasília. Brasília. Acesso em: 19 abr. 2026.
...
| ------ | ----- | ------------------------------------- | -------------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------- |
| 1.0    | 19/04 | Criação do documento                  | [Yasmin Nascimento](https://github.com/Yasm1nNasc1mento) | [Isabella Choukaira](https://github.com/isabellachoukaira) | Documento criado                                        |
| 1.1    | 22/04 | Revisão textual e ajustes estruturais | [Eduarda Rodrigues](https://github.com/eduardar0)        | [Isabella Choukaira](https://github.com/isabellachoukaira) | Correção gramatical, padronização e melhoria de clareza |
| 1.1    | 22/04 | Acrescenta mais referências | [Isabella Choukaira](https://github.com/isabellachoukaira)        | [Yasmin Nascimento](https://github.com/Yasm1nNasc1mento) | Revisado e Aprovado |
